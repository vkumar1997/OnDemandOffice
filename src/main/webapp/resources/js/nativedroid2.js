    ...
    (function($) {
        $.nd2Search = function(options) {
            ...
            _self.getSearchButton = function(offset) {
                return "<a href='#' id='s_button' class='ui-btn ui-btn-right wow fadeIn nd2-search-button' style='margin-right: " + offset + "px;' data-wow-delay='1s'><i class='zmdi zmdi-search'></i></a>";
            };
            ...
            _self.getSearchInput = function() {
                return "<input type='text' id='search' class='nd2-search-input' value='' placeholder='" + _self.options.placeholder + "' />";
            };
